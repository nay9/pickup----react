...
public class Initializer  implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		PickupRequest requestPickup = orderRepo.save(new PickupRequest("Home Depot", "Renes moms", "date", "time", "Couch", "https://images-na.ssl-images-amazon.com/images/I/51nRhGW4%2BdL._AC_SY200_.jpg", driver));
		
		orderRepo.save(requestPickup);
		

		PickupRequest requestPickup2 = orderRepo.save(new PickupRequest("Lowe's", "School","date","time","Lumber", "https://ak1.ostkcdn.com/images/products/14548038/P21099142.jpg?impolicy=medium&imwidth=200"));
